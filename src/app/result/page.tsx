...
export default function ResultPage() {
  ...
  return (
    <div className="page-shell flex flex-col items-center justify-center py-8">
      <Card className="animated-card w-full max-w-md overflow-hidden border-primary/20 bg-card/80 backdrop-blur-xl">
        <CardHeader className="space-y-3 px-6 pt-6 text-center sm:px-8 sm:pt-8">
        ...
        <CardContent className="space-y-5 px-6 pb-6 pt-0 sm:px-8">
        ...
        <CardFooter className="flex flex-col gap-3 px-6 pb-6 sm:px-8">
          ...
          <Button
            asChild
            variant="outline"
            className="w-full rounded-2xl border-primary/20 bg-background/70 transition-all hover:-translate-y-1 hover:border-primary/40"
          >
